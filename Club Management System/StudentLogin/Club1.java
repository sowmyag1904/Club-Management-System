...
public class Club1 {
    ...
    public static <ActionEvent> void main(String[] args) {
        ...
        ImageIcon image = new ImageIcon("assets\\images\\smc.jpg");
        ...
        JLabel head = new JLabel("SSN MUSIC CLUB (SMC)");
        ...
        JLabel desc = new JLabel("SSN Music Club is a great place to showcase your musical talents!");
