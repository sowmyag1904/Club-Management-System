...
public class Club4 {
    public static <ActionEvent> void main(String[] args) {
        ...
        ImageIcon image = new ImageIcon("assets\\images\\n2k.jpg");
        ...
        JLabel head = new JLabel("N2K (WESTERN DANCE CLUB)");
        ...
        JLabel desc = new JLabel("Come join our western dance club - famous for hip-hop, freestyle and street moves!");
